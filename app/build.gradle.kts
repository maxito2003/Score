...
layout.buildDirectory.set(file("C:/tmp/CLUBHOME/app_build"))

android {
    namespace = "com.example.clubhome"
    compileSdk {
        version = release(37)
    }

    defaultConfig {
        applicationId = "com.example.clubhome"
        minSdk = 30
        targetSdk = 37
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Navigation & ViewModel Compose & Icons
